...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'ETTh2', 'ETTm1','MyData'], help='name of dataset')
...
data_parser = {
    ...
    'MyData': {'data': 'train.csv', 'T': 'Value', 'M': [7,7,7], 'S': [1, 1, 1], 'MS': [7,7,1]},
}
